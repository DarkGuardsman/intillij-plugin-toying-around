...
package com.example.toyingaround.lang.language.parser;
...
public class LangParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // (KEY? SEPARATOR property_value?) | KEY
  ...
  private static boolean property_0_2(PsiBuilder b, int l) {
    ...
    property_value(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // WORD | COLOR_CODE | WHITE_SPACE
  public static boolean property_value(PsiBuilder b, int l) {
    ...
    if (!r) r = consumeToken(b, COLOR_CODE);
